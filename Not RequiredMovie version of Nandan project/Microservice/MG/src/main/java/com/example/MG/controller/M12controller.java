...
public class M12controller {
    ...
    public M12 getCatalog(@PathVariable String classAId) {
        ...
        M2 m2 = restTemplate.getForObject("http://localhost:3002/field2/getrating/" + classAId, M2.class);
        return new M12(m1.getName(), m1.getDescription(), m2.getRating(), m2.getMovieId());
